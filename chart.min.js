...
class DatasetController {
    ...
    parseArrayData(t, e, i, a) {
        ...
        let o, l, h, d;
        for (o = 0, l = a; o < l; ++o) d = e[h = o + i], r[o] = {
            x: s.parse(d[0], h),
            y: n.parse(d[1], h)
        };
        return r
    ...
    parseObjectData(t, e, i, a) {
        ...
        const l = new Array(a);
        let h, d, c, u;
        for (h = 0, d = a; h < d; ++h) u = e[c = h + i], l[h] = {
...
class BubbleController extends DatasetController {
    ...
    updateElements(e, i, a, s) {
        ...
        var {
            sharedOptions: l,
            includeOptions: h
        } = this._getSharedOptions(i, s), d = r.axis, c = o.axis;
        for (let t = i; t < i + a; t++) {
            var u = e[t],
...
class LineController extends DatasetController {
    ...
    updateElements(e, i, t, a) {
        ...
        var {
            sharedOptions: h,
            includeOptions: d
        } = this._getSharedOptions(i, a), c = n.axis, u = r.axis, {
            spanGaps: g,
            segment: p
...
class ScatterController extends DatasetController {
    ...
    update(t) {
        ...
        var {
            data: i = []
        } = e, a = this.chart._animationsDisabled;
        let {
            start: s,
            count: n
    ...
    updateElements(e, i, a, s) {
        ...
        for (let t = i; t < i + a; ++t) {
            ...
            D.skip = isNaN(k) || isNaN(S) || y, D.stop = 0 < t && Math.abs(_[u] - x[u]) > m, f && (D.parsed = _, D.raw = h.data[t]), c && (D.options = d || this.resolveDataElementOptions(t, b.active ? "active" : s)), v || this.updateElement(b, t, D, s), x = _
        }
...
function titleArgs(t, e, i, a) {
    ...
    var f, m, l = r - s,
        v = o - n;
    return t.isHorizontal() ? (g = _alignStartEnd(a, n, o), p = isObject(i) ? (m = i[f = Object.keys(i)[0]], d[f].getPixelForValue(m) + l - e) : "center" === i ? (h.bottom + h.top) / 2 + l - e : offsetFromEdge(t, i, e), u = o - n) : (g = isObject(i) ? (m = i[f = Object.keys(i)[0]], d[f].getPixelForValue(m) - v + e) : "center" === i ? (h.left + h.right) / 2 - v + e : offsetFromEdge(t, i, e), p = _alignStartEnd(a, r, s), c = "left" === i ? -HALF_PI : HALF_PI), {
        titleX: g,
        titleY: p,
        maxWidth: u,
        rotation: c
...
class Scale extends Element {
    ...
    fit() {
        ...
        var e, i, a, s, n, {
            ...
            d = this._isVisible(),
            c = this.isHorizontal();
        d && (d = getTitleHeight(l, r.options.font), c ? (t.width = this.maxWidth, t.height = getTickMarkLength(h) + d) : (t.height = this.maxHeight, t.width = getTickMarkLength(h) + d), o.display && this.ticks.length && ({
            first: l,
            last: h,
            widest: d,
            highest: e
    ...
    _computeLabelSizes(t, e, i) {
        ...
        for (d = 0; d < e; d += o) {
            if (g = t[d].label, p = this._resolveTickFontOptions(d), a.font = f = p.string, m = s[f] = s[f] || {
                ...
                if (isArray(g))
                    for (c = 0, u = g.length; c < u; ++c) _ = g[c], isNullOrUndef(_) || isArray(_) || (x = _measureText(a, m.data, m.gc, x, _), b += v)
    ...
    _computeGridLineItems(t) {
        ...
        for (x = 0; x < h; x += C) {
            ...
            void 0 !== (b = getPixelForGridLine(this, x, o)) && (_ = _alignPixel(i, b, T), l ? y = S = M = A = _ : k = D = P = w = _, c.push({
                tx1: y,
                ty1: k,
                tx2: S,
                ty2: D,
    ...
    _computeLabelItems(t) {
        ...
        for (f = 0, m = o.length; f < m; ++f) {
            ...
            var w = s.setContext(this.getContext(f)),
                ...
                T = w.textStrokeWidth;
            let t = _;
            r ? (x = y, "inner" === _ && (t = f === m - 1 ? this.options.reverse ? "left" : "right" : 0 === f ? this.options.reverse ? "right" : "left" : "center"), M = "top" === a ? "near" === h || 0 != g ? -D * S + S / 2 : "center" === h ? -A.highest.height / 2 - C * S + S : -A.highest.height + S / 2 : "near" === h || 0 != g ? S / 2 : "center" === h ? A.highest.height / 2 - C * S : A.highest.height - D * S, c && (M *= -1), 0 == g || w.showLabelBackdrop || (x += S / 2 * Math.sin(g))) : (b = y, M = (1 - D) * S / 2);
            let i;
    ...
    drawBorder() {
        ...
        if (l) {
            var h = r.setContext(this.getContext(0)).lineWidth,
                d = this._borderValue;
            let t, e, i, a;
            this.isHorizontal() ? (t = _alignPixel(s, this.left, l) - l / 2, e = _alignPixel(s, this.right, h) + h / 2, i = a = d) : (i = _alignPixel(s, this.top, l) - l / 2, a = _alignPixel(s, this.bottom, h) + h / 2, t = e = d), n.save(), n.lineWidth = o.width, n.strokeStyle = o.color, n.beginPath(), n.moveTo(t, i), n.lineTo(e, a), n.stroke(), n.restore()
        }
    }
    drawLabels(t) {
    ...
    return Object.keys(o).forEach(t => {
        ...
        Object.keys(n).forEach(t => {
            var e = getAxisFromDefaultScaleID(t, s),
                i = a[e + "AxisID"] || e;
            h[i] = h[i] || Object.create(null), mergeIf(h[i], [{
                axis: e
            }, o[i], n[t]])
        })
...
function pathArc(t, e, i, a, s, n) {
    var {
        ...
        pixelMargin: h,
        innerRadius: d
    } = e, c = Math.max(e.outerRadius + a + i - h, 0), h = 0 < d ? d + a + i + h : 0;
    let u = 0;
    var g = s - l,
        d = (a && (d = ((0 < d ? d - a : 0) + (0 < c ? c - a : 0)) / 2, u = (g - (0 != d ? g * d / (d + a) : g)) / 2), Math.max(.001, g * c - i / PI) / c),
        a = (g - d) / 2,
        i = l + a + u,
        g = s - a - u,
        {
...
function fastPathSegment(t, e, i, a) {
    ...
    for (l && (g = s[y(0)], t.moveTo(g.x, g.y)), u = 0; u <= o; ++u)(g = s[y(u)]).skip || (x = g.x, b = g.y, (_ = 0 | x) === p ? (b < f ? f = b : b > m && (m = b), d = (c * d + x) / ++c) : (k(), t.lineTo(x, b), p = _, c = 0, f = m = b), v = b);
    k()
}
...
function lttbDecimation(a, s, n, t, e) {
    ...
    for (r[l++] = a[h], d = 0; d < i - 2; d++) {
        ...
        for (u = -1, i = f; i < x; i++)(g = .5 * Math.abs((b - t) * (a[i].y - _) - (b - a[i].x) * (e - _))) > u && (u = g, c = a[i], p = i);
        r[l++] = c, h = p
    }
    return r[l++] = a[e], r
}
...
function minMaxDecimation(t, e, i, a) {
    ...
    for (r = e; r < e + i; ++r) {
        ...
        var b, _, y, k = 0 | l;
        k === d ? (h < p ? (p = h, c = r) : h > f && (f = h, u = r), s = (n * s + o.x) / ++n) : (b = r - 1, isNullOrUndef(c) || isNullOrUndef(u) || (_ = Math.min(c, u), y = Math.max(c, u), _ !== g && _ !== b && m.push({
            ...t[_],
            x: s
        }), y !== g && y !== b && m.push({
            ...t[y],
...
function _segments(t, e, i) {
    ...
    for (const c of a) {
        ...
        } = c, l = _findSegmentEnd(o, l, s), h = _getBounds(i, s[o], s[l], c.loop);
        if (e.segments)
            for (const u of _boundSegments(e, h)) {
                var d = _getBounds(i, n[u.start], n[u.end], u.loop);
                for (const g of _boundSegment(c, s, d)) r.push({
                    source: g,
                    target: u,
                    start: {
...
function clipVertical(t, e, i) {
    ...
    for (const d of a) {
        ...
        } = d, h = s[o], o = s[_findSegmentEnd(o, l, s)];
...
function fill(e, t) {
    ...
    for ({
        ...
        } = o, u = !0 !== a, c = (e.save(), e.fillStyle = c, clipBounds(e, r, u && _getBounds(s, h, d)), e.beginPath(), !!i.pathSegment(e, o));
        let t;
        u && (c ? e.closePath() : interpolatedLineTo(e, a, d, s), u = !!a.pathSegment(e, l, {
            move: c,
            reverse: !0
        }), (t = c && u) || interpolatedLineTo(e, a, h, s)), e.closePath(), e.fill(t ? "evenodd" : "nonzero"), e.restore()
    }
}
...
class Legend extends Element {
    ...
    _fitRows(t, i, a, s) {
        ...
        } = this, l = this.legendHitBoxes = [], h = this.lineWidths = [0], d = s + o;
        let c = t,
    ...
    _fitCols(t, a, s, n) {
        ...
        } = this, l = this.legendHitBoxes = [], h = this.columnSizes = [], d = e - t;
        let c = o,
            u = 0,
            g = 0,
            p = 0,
    ...
    _draw() {
        ...
        const {
            ...
            boxHeight: P,
            itemHeight: A
        } = getBoxSize(v, k), w = this.isHorizontal(), C = this._computeTitleHeight(), O = (D = w ? {
            ...
            line: 0
        }, overrideTextDirection(this.ctx, u.textDirection), A + y);
        this.legendItems.forEach((t, e) => {
            ...
            let s = D.x,
                n = D.y;
            b.setWidth(this.width), w ? 0 < e && s + i + y > this.right && (n = D.y += O, D.line++, s = D.x = _alignStartEnd(m, this.left + y, this.right - p[D.line])) : 0 < e && n + O > this.bottom && (s = D.x = s + g[D.line].width + y, D.line++, n = D.y = _alignStartEnd(m, this.top + C + y, this.bottom - g[D.line].height));
            var r, o, l, h, d, c, e = b.x(s);
            e = e, h = n, d = t, isNaN(M) || M <= 0 || isNaN(P) || P < 0 || (f.save(), r = valueOrDefault(d.lineWidth, 1), f.fillStyle = valueOrDefault(d.fillStyle, x), f.lineCap = valueOrDefault(d.lineCap, "butt"), f.lineDashOffset = valueOrDefault(d.lineDashOffset, 0), f.lineJoin = valueOrDefault(d.lineJoin, "miter"), f.lineWidth = r, f.strokeStyle = valueOrDefault(d.strokeStyle, x), f.setLineDash(valueOrDefault(d.lineDash, [])), v.usePointStyle ? (o = {
                radius: P * Math.SQRT2 / 2,
                pointStyle: d.pointStyle,
                rotation: d.rotation,
                borderWidth: r
            }, l = b.xPlus(e, M / 2), c = h + S, drawPointLegend(f, o, l, c, v.pointStyleWidth && M)) : (o = h + Math.max((k - P) / 2, 0), l = b.leftForLtr(e, M), c = toTRBLCorners(d.borderRadius), f.beginPath(), Object.values(c).some(t => 0 !== t) ? addRoundedRectPath(f, {
                x: l,
                y: o,
                w: M,
                h: P,
                radius: c
            }) : f.rect(l, o, M, P), f.fill(), 0 !== r && f.stroke()), f.restore()), s = _textX(a, s + M + S, w ? s + i : this.right, u.rtl), h = b.x(s), e = n, d = t, renderText(f, d.text, h, e + A / 2, _, {
...
class Title extends Element {
    ...
    _drawArgs(t) {
        ...
        let o = 0,
            l, h, d;
        return l = this.isHorizontal() ? (h = _alignStartEnd(r, i, s), d = e + t, s - i) : (o = "left" === n.position ? (h = i + t, d = _alignStartEnd(r, a, e), -.5 * PI) : (h = s - t, d = _alignStartEnd(r, e, a), .5 * PI), a - e), {
            titleX: h,
            titleY: d,
            maxWidth: l,
            rotation: o
...
function getTooltipSize(t, e) {
    ...
    var {
        boxWidth: r,
        boxHeight: o
    } = e, l = toFont(e.bodyFont), h = toFont(e.titleFont), d = toFont(e.footerFont), c = n.length, u = s.length, g = a.length, p = toPadding(e.padding);
    let f = p.height,
        m = 0;
    ...
    }), x = 0, i.font = d.string, each(t.footer, b), i.restore(), {
        width: m += p.width,
        height: f
    }
}
...
class Tooltip extends Element {
    ...
    _drawColorBox(t, e, i, a, s) {
        ...
        s.usePointStyle ? (d = {
            ...
            rotation: o.rotation,
            borderWidth: 1
        }, o = a.leftForLtr(c, h) + h / 2, n = e + l / 2, t.strokeStyle = s.multiKeyBackground, t.fillStyle = s.multiKeyBackground, drawPoint(t, d, o, n), t.strokeStyle = r.borderColor, t.fillStyle = r.backgroundColor, drawPoint(t, d, o, n)) : (t.lineWidth = isObject(r.borderWidth) ? Math.max(...Object.values(r.borderWidth)) : r.borderWidth || 1, t.strokeStyle = r.borderColor, t.setLineDash(r.borderDash || []), t.lineDashOffset = r.borderDashOffset || 0, d = a.leftForLtr(c, h), o = a.leftForLtr(a.xPlus(c, 1), h - 2), n = toTRBLCorners(r.borderRadius), Object.values(n).some(t => 0 !== t) ? (t.beginPath(), t.fillStyle = s.multiKeyBackground, addRoundedRectPath(t, {
            x: d,
            y: e,
            w: h,
            h: l,
    ...
    drawBody(e, i, t) {
        ...
        var f = g.textAlign(n);
        let m, v, x, b, _, y, k;
        for (i.textAlign = n, i.textBaseline = "middle", i.font = d.string, e.x = getAlignedX(this, f, t), i.fillStyle = t.bodyColor, each(this.beforeBody, p), u = r && "right" !== f ? "center" === n ? l / 2 + h : l + 2 + h : 0, b = 0, y = a.length; b < y; ++b) {
            for (m = a[b], v = this.labelTextColors[b], i.fillStyle = v, each(m.before, p), x = m.lines, r && x.length && (this._drawColorBox(i, e, b, g, t), c = Math.max(d.lineHeight, o)), _ = 0, k = x.length; _ < k; ++_) p(x[_]), c = d.lineHeight;
            each(m.after, p)
        }
    ...
    _getActiveElements(t, e, i, a) {
        var s = this.options;
        if ("mouseout" === t.type) return [];
        if (!a) return e.filter(t => this.chart.data.datasets[t.datasetIndex] && void 0 !== this.chart.getDatasetMeta(t.datasetIndex).controller.getParsed(t.index));
...
function generateTicks$1(t, e) {
    ...
    var {
        ...
        min: e,
        max: p
    } = e, f = !isNullOrUndef(n), m = !isNullOrUndef(r), v = !isNullOrUndef(l), d = (p - e) / (d + 1);
    ...
    for (f && (c && _ !== n ? (i.push({
            value: n
        }), _ < n && S++, almostEquals(Math.round((_ + S * x) * b) / b, n, relativeLabelSize(n, d, t)) && S++) : _ < n && S++); S < k; ++S) {
...
function drawPointLabelBox(t, e, i) {
    var a, s, {
        ...
        l = e["backdropColor"];
    isNullOrUndef(l) || (a = toTRBLCorners(e.borderRadius), e = toPadding(e.backdropPadding), t.fillStyle = l, l = i - e.left, s = n - e.top, r = r - i + e.width, i = o - n + e.height, Object.values(a).some(t => 0 !== t) ? (t.beginPath(), addRoundedRectPath(t, {
        x: l,
        y: s,
        w: r,
        h: i,
...
function drawPointLabels(e, i) {
    ...
    for (let t = i - 1; 0 <= t; t--) {
        ...
        h.visible && (drawPointLabelBox(a, n = s.setContext(e.getPointLabelContext(t)), h), r = toFont(n.font), {
            x: h,
            y: o,
            textAlign: l
        } = h, renderText(a, e._pointLabels[t], h, o + r.lineHeight / 2, r, {
            color: n.color,
            textAlign: l,
            textBaseline: "middle"
        }))
...
class TimeScale extends Scale {
    ...
    _generate() {
        ...
        return d !== i && "ticks" !== a.bounds && 1 !== c || addTick(l, d, u), Object.keys(l).sort(sorter).map(t => +t)
    }
    getLabelForValue(t) {
        const e = this._adapter;
